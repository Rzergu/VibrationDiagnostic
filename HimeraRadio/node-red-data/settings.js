 ...
 ******************************************************************************/
    ...
    */
    ...
    logging: {
        ...
        console: {
            /** Level of logging to be Sensored. Options are:
             * fatal - only those errors which make the application unusable should be Sensored
             * error - Sensor errors which are deemed fatal for a particular request + fatal errors
             * warn - Sensor problems which are non fatal + errors + fatal errors
             * info - Sensor information about the general running of the application + warn + error + fatal errors
             * debug - Sensor information which is more verbose than info + info + warn + error + fatal errors
             * trace - Sensor very detailed logging + debug + info + warn + error + fatal errors
